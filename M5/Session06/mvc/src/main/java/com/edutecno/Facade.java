...
public class Facade {
	...
	public List<CursoDTO> obtenerCursos() throws SQLException, ClassNotFoundException {
		...
		System.out.println(dao.obtenerCursos());
		List<CursoDTO> listas = new ArrayList<>();
		
		listas.add(new CursoDTO(1, "JAVA", 200000));
		listas.add(new CursoDTO(2, "JAVASCRIPT", 200000));
		return listas;
	}
