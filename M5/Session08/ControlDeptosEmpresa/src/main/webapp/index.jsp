		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<form method="get" action="procesaBusquedaEmpleado">
						<!-- Content Row -->
						<div class="row">
								...
								<div class="card border-left-info shadow h-100 py-2">
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												<div
													class="text-xs font-weight-bold text-info text-uppercase mb-1">Departamento
													Empleado</div>
						...
						<div class="col-lg-6 mb-4">
							...
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">Crear
										Empleado</h6>
								</div>
								<div class="card-body">
									<form method="post" action="creaEmpleado">
										<label>Nombre</label> <input type="text" name="nombre" /> <label>Departamento</label>
										<input type="text" name="depto" />
