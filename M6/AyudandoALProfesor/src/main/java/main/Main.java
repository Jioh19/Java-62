...
public class Main {
	...
	public static void main(String[] args) {
		...
		ICalculadora calculadora2 = new Calculadora2(alumnos);
		ICalculadora calculadora3 = new Calculadora3(alumnos);
		Profesor profesor = new Profesor(calculadora, calculadora2, calculadora3);
